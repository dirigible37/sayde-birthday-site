    ...
    `}>
      ...
      <div className="relative">
        ...
        <div className={`
          ...
          ${showGiftCard ? 'scale-100 opacity-100 translate-y-0' : 'scale-0 opacity-0 translate-y-8'}
        `}>
          <div className="bg-gradient-to-br from-purple-600 via-blue-600 to-teal-600 p-8 rounded-2xl shadow-2xl max-w-sm">
            <div className="text-center text-white">
              <h2 className="text-2xl font-bold mb-4">🎉 Happy Birthday! 🎉</h2>
        ...
        <div className={`
          ...
          ${showGiftCard ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}
        `}>
          <div className="text-center text-white bg-black/30 backdrop-blur-sm rounded-xl p-6">
            <h1 className="text-3xl font-bold mb-2">Happy 35th Birthday, Sayde! 🎂</h1>
            <p className="text-lg opacity-90">Hope your day is as amazing as you are!</p>
          </div>
        </div>
      </div>
    </div>
